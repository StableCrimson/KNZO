...
'''.splitlines())[1:] # Kinda cursed, might have to bake this into a function

knzo.comms(rope_core_memory_rant, autopause=True, sentence_pause_delay_ms=150)

'''
Voyager has finally gone silent.
'''

'''
We are different, that we can agree on. But if you think that the only thing
that separates us is flesh and metal then you are sorely mistaken.
'''
